...
\label{sec:org6ea3bdd}

\subsection{Niño 3.4 Variance}
\label{sec:org907e898}
...
\caption{\label{fig:tempcep}Correlation coefficient between detrended and smoothed ocean temperature of the central pacific slice and detrended and smoothed Niño 3.4 variance. Grey color indicates points where p>0.05.}
\end{figure}

\section{Conclusions and Discussion}
\label{sec:org811a462}
