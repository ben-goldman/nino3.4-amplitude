...
\begin{frame}{Measuring ENSO Intensity}
  \begin{tikzpicture}[node distance = .37\textwidth, line width = 0.5mm]
    \node [process] (input) {
...
\begin{frame}{ENSO is Becoming Stronger}
  \begin{columns}
    ...
    \begin{figure}
      \begin{tikzpicture}
        \node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=\textwidth]{figures/ff_compare.pdf}};
        \coordinate (a) at (1.0, 1.5);
        \node [red] (b) at (1.3, 1.0) {
        ...
        \node [red] (e) at (4.3, 1.0) {
          \begin{varwidth}{0.6in}
            Decreasing variance
          \end{varwidth}};
        \coordinate (f) at (5.0, 1.5) {};
        \draw[red, |-|] (d) to (f);
      \end{tikzpicture}
