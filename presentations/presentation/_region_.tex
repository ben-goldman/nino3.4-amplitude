...
\begin{frame}{El Niño}
  \begin{columns}
    ...
    \item Affects human societies through temperature and rainfall.
    \item May be affected by climate change.
    \end{itemize}
    \mifig{intro_fig.pdf}{Comparison of SST Anomaly Between 1997 El Niño event and 1975 La Niña event in HadISST 1 dataset. \citep{rayner2003global}}
  \end{columns}
\end{frame}
...
\message{ !name(presentation.tex) !offset(-209) }
