...
\begin{frame}[label={sec:org91e1c08}]{What is El Niño/Southern Oscillation (ENSO)?}
\begin{columns}
...
\begin{frame}[label={sec:org5f7e4ec}]{Long-Term vs Short-Term Change}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org3adee30}]{Review of literature}
\begin{itemize}
...
\begin{frame}[label={sec:org1492cdc}]{Research Goals}
\begin{itemize}
...
\begin{frame}[label={sec:orgc837d3d}]{Data: the CESM1 Large Ensemble}
\begin{itemize}
...
\begin{frame}[label={sec:org5c44c75}]{Niño 3.4 Variance}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org8bfbd4b}]{Butterfly Effect: The Need for a Large Ensemble}
\begin{columns}
...
\begin{frame}[label={sec:org7c52937}]{Model Predictions: ENSO in the Future}
\begin{columns}
...
\begin{frame}[label={sec:orge7e784d}]{Role of Greenhouse and Aerosol Emissions}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orga9b609d}]{Correlation With Changes in Ocean Temperature}
\begin{itemize}
...
\begin{frame}[label={sec:org81efb26}]{Physical Mediator: Heating Difference}
\begin{columns}
...
\begin{frame}[label={sec:orgeac6a2d}]{Conclusion and Discussion}
\begin{itemize}
...
\begin{frame}[label={sec:orgb0a7373}]{Applications, Next Steps, Limitations}
\begin{itemize}
...
\begin{frame}[label={sec:orgbef5f98}]{Acknowledgements}
\begin{itemize}
...
\begin{frame}[label={sec:org99c254a}]{References}
