...
\begin{frame}[label={sec:org3a2b290}]{What is El Niño/Southern Oscillation (ENSO)?}
\begin{columns}
...
\begin{frame}[label={sec:org82e6eda}]{Long-Term vs Short-Term Change}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgc6e3570}]{Review of literature}
\begin{itemize}
...
\begin{frame}[label={sec:org514c83e}]{Research Goals}
\begin{itemize}
...
\begin{frame}[label={sec:orge5e22ee}]{Data: the CESM1 Large Ensemble}
\begin{itemize}
...
\begin{frame}[label={sec:orgc40518a}]{Niño 3.4 Variance}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgae620b1}]{Butterfly Effect: The Need for a Large Ensemble}
\begin{columns}
...
\begin{frame}[label={sec:orgd198f85}]{Model Predictions: ENSO in the Future}
\begin{columns}
...
\begin{frame}[label={sec:org81c8216}]{Analysis of Individual Factors}
\begin{itemize}
...
\begin{frame}[label={sec:orgc1945dc}]{Role of Greenhouse and Aerosol Emissions}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgeb8bfbe}]{Correlation With Changes in Ocean Temperature}
\begin{itemize}
...
\begin{frame}[label={sec:org80b8911}]{Physical Mediator: Heating Difference}
\begin{columns}
...
\begin{frame}[label={sec:orgf45e4aa}]{Conclusion and Discussion}
\begin{itemize}
...
\begin{frame}[label={sec:orgb0efbd3}]{Applications, Next Steps, Limitations}
\begin{itemize}
...
\begin{frame}[label={sec:org30b35b8}]{Acknowledgements}
\begin{itemize}
...
\begin{frame}[label={sec:org37198dc}]{References}
