...
\DeclareUnicodeCharacter{0303}{\~{n}}
\usetheme{metropolis}
...
\begin{frame}[label={sec:org8153378}]{What is El Niño/Southern Oscillation (ENSO)?}
\begin{columns}
...
\begin{frame}[label={sec:org30dba5e}]{Long-Term vs Short-Term Change}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orge54f468}]{Review of literature}
\begin{itemize}
...
\begin{frame}[label={sec:org85f5f49}]{Research Goals}
\begin{itemize}
...
\begin{frame}[label={sec:org6749e99}]{Data: the CESM1 Large Ensemble}
\begin{itemize}
\item Explore hypothetical scenarios with a computer model \citep{kay2015community}.
...
\begin{frame}[label={sec:org650aae3}]{Niño 3.4 Variance}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgdfcbcd5}]{Butterfly Effect: The Need for a Large Ensemble}
\begin{columns}
...
\begin{frame}[label={sec:org7d549e7}]{Model Predictions: ENSO in the Future}
\begin{columns}
...
\begin{frame}[label={sec:org3a535ea}]{Analysis of Individual Factors}
\begin{itemize}
...
\begin{frame}[label={sec:org87d91c6}]{Role of Greenhouse and Aerosol Emissions}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org1369c26}]{Correlation With Changes in Ocean Temperature}
\begin{itemize}
...
\begin{frame}[label={sec:org10d0dfb}]{Physical Mediator: Heating Difference}
\begin{columns}
...
\begin{frame}[label={sec:orga972c2c}]{Conclusion and Discussion}
\begin{itemize}
...
\begin{frame}[label={sec:orgb31e23e}]{Applications, Next Steps, Limitations}
\begin{itemize}
...
\begin{frame}[label={sec:org35dd772}]{Acknowledgements}
\begin{itemize}
...
\begin{frame}[label={sec:org98d3ee4}]{References}
