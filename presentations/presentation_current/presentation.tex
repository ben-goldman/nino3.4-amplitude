...
\begin{frame}[label={sec:org6e6eccf}]{What is El Niño/Southern Oscillation (ENSO)?}
\begin{columns}
...
\begin{frame}[label={sec:org6b9d33a}]{Long-Term vs Short-Term Change}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org24e313e}]{Review of literature}
\begin{itemize}
...
\begin{frame}[label={sec:org77e0249}]{Research Goals}
\begin{itemize}
...
\begin{frame}[label={sec:orgd6cf415}]{Data: the CESM1 Large Ensemble}
\begin{itemize}
...
\begin{frame}[label={sec:org2cd69f1}]{Niño 3.4 Variance}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org8562e6e}]{Butterfly Effect: The Need for a Large Ensemble}
\begin{columns}
...
\begin{frame}[label={sec:orgfda20ee}]{Model Predictions: ENSO in the Future}
\begin{columns}
...
\begin{frame}[label={sec:org5795ab7}]{Analysis of Individual Factors}
\begin{itemize}
...
\begin{frame}[label={sec:orgd092c4d}]{Role of Greenhouse and Aerosol Emissions}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org4409680}]{Correlation With Changes in Ocean Temperature}
\begin{itemize}
...
\begin{frame}[label={sec:org52a5575}]{Physical Mediator: Heating Difference}
\begin{columns}
...
\begin{frame}[label={sec:org3c6bb69}]{Conclusion and Discussion}
\begin{itemize}
...
\begin{frame}[label={sec:orgdf5ae8f}]{Applications, Next Steps, Limitations}
\begin{itemize}
...
\begin{frame}[label={sec:org8ed07de}]{Acknowledgements}
\begin{itemize}
...
\begin{frame}[label={sec:orgc3b51d1}]{References}
