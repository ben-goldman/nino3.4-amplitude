...
\begin{frame}[label={sec:orgb1df2b4}]{What is El Niño/Southern Oscillation (ENSO)?}
\begin{columns}
...
\begin{frame}[label={sec:orga0cf916}]{Long-Term vs Short-Term Change}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org8f2e28a}]{Review of literature}
\begin{itemize}
...
\begin{frame}[label={sec:org26b0634}]{Research Goals}
\begin{itemize}
...
\begin{frame}[label={sec:org389fba7}]{Data: the CESM1 Large Ensemble}
\begin{itemize}
...
\begin{frame}[label={sec:org80dd814}]{Niño 3.4 Variance}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org8592647}]{Butterfly Effect: The Need for a Large Ensemble}
\begin{columns}
...
\begin{frame}[label={sec:orgf5c3604}]{Model Predictions: ENSO in the Future}
\begin{columns}
...
\begin{frame}[label={sec:org9a47952}]{Analysis of Individual Factors}
\begin{itemize}
...
\begin{frame}[label={sec:org0a966de}]{Role of Greenhouse and Aerosol Emissions}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org288c45c}]{Correlation With Changes in Ocean Temperature}
\begin{itemize}
...
\begin{frame}[label={sec:org8bce193}]{Physical Mediator: Heating Difference}
\begin{columns}
...
\begin{frame}[label={sec:orge890f4d}]{Conclusion and Discussion}
\begin{itemize}
...
\begin{frame}[label={sec:orge9c36c0}]{Applications, Next Steps, Limitations}
\begin{itemize}
...
\begin{frame}[label={sec:org4cda3b8}]{Acknowledgements}
\begin{itemize}
...
\begin{frame}[label={sec:org3d198c1}]{References}
