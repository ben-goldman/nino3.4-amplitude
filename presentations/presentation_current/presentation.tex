...
\begin{frame}[label={sec:org94c92b5}]{What is El Niño/Southern Oscillation (ENSO)?}
\begin{columns}
...
\begin{frame}[label={sec:orga6e57de}]{Long-Term vs Short-Term Change}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org98f4b82}]{Review of literature}
\begin{itemize}
...
\begin{frame}[label={sec:orgeb64aee}]{Research Goals}
\begin{itemize}
...
\begin{frame}[label={sec:orgced4cac}]{Data: the CESM1 Large Ensemble}
\begin{itemize}
...
\begin{frame}[label={sec:orgc2d187b}]{Niño 3.4 Variance}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org2b84dfc}]{Butterfly Effect: The Need for a Large Ensemble}
\begin{columns}
...
\begin{frame}[label={sec:org82b4406}]{Model Predictions: ENSO in the Future}
\begin{columns}
...
\begin{frame}[label={sec:orgc997c2e}]{Analysis of Individual Factors}
\begin{itemize}
...
\begin{frame}[label={sec:org948ad63}]{Role of Greenhouse and Aerosol Emissions}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orga1b0a8e}]{Correlation With Changes in Ocean Temperature}
\begin{itemize}
...
\begin{frame}[label={sec:org93082a0}]{Physical Mediator: Heating Difference}
\begin{columns}
...
\begin{frame}[label={sec:orgff36aaf}]{Conclusion and Discussion}
\begin{itemize}
...
\begin{frame}[label={sec:org6ab9458}]{Applications, Next Steps, Limitations}
\begin{itemize}
...
\begin{frame}[label={sec:orgccfbd1e}]{Acknowledgements}
\begin{itemize}
...
\begin{frame}[label={sec:org45ad4cf}]{References}
