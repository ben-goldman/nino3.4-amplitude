...
\begin{frame}[label={sec:org6324502}]{What is El Niño/Southern Oscillation (ENSO)?}
\begin{columns}
...
\begin{frame}[label={sec:orga9c1cb1}]{Long-Term vs Short-Term Change}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orge51aa65}]{Review of literature}
\begin{itemize}
...
\begin{frame}[label={sec:org0833bc2}]{Research Goals}
\begin{itemize}
...
\begin{frame}[label={sec:orgb114c8a}]{Data: the CESM1 Large Ensemble}
\begin{itemize}
...
\begin{frame}[label={sec:orgb922573}]{Niño 3.4 Variance}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgfda0878}]{Butterfly Effect: The Need for a Large Ensemble}
\begin{columns}
...
\begin{frame}[label={sec:org54ceb45}]{Model Predictions: ENSO in the Future}
\begin{columns}
...
\begin{frame}[label={sec:org09b2b52}]{Analysis of Individual Factors}
\begin{itemize}
...
\begin{frame}[label={sec:org64fbfaf}]{Role of Greenhouse and Aerosol Emissions}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgb590ee5}]{Correlation With Changes in Ocean Temperature}
\begin{itemize}
...
\begin{frame}[label={sec:org420b553}]{Physical Mediator: Heating Difference}
\begin{columns}
...
\begin{frame}[label={sec:orgb66a216}]{Conclusion and Discussion}
\begin{itemize}
...
\begin{frame}[label={sec:org527ca8d}]{Applications, Next Steps, Limitations}
\begin{itemize}
...
\begin{frame}[label={sec:orgdaf6ace}]{Acknowledgements}
\begin{itemize}
...
\begin{frame}[label={sec:orgd4caeb0}]{References}
