...
\begin{frame}[label={sec:org4e471fb}]{What is El Niño/Southern Oscillation (ENSO)?}
\begin{columns}
...
\begin{frame}[label={sec:orgbda0410}]{Long-Term vs Short-Term Change}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org86b3819}]{Review of literature}
\begin{itemize}
...
\begin{frame}[label={sec:orga816529}]{Research Goals}
\begin{itemize}
...
\begin{frame}[label={sec:org6382c25}]{Data: the CESM1 Large Ensemble}
\begin{itemize}
...
\begin{frame}[label={sec:orgdd97104}]{Niño 3.4 Variance}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org95b465d}]{Butterfly Effect: The Need for a Large Ensemble}
\begin{columns}
...
\begin{frame}[label={sec:org9e668e7}]{Model Predictions: ENSO in the Future}
\begin{columns}
...
\begin{frame}[label={sec:orgdeea30d}]{Analysis of Individual Factors}
\begin{itemize}
...
\begin{frame}[label={sec:org2a9fa36}]{Role of Greenhouse and Aerosol Emissions}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org56f69a6}]{Correlation With Changes in Ocean Temperature}
\begin{itemize}
...
\begin{frame}[label={sec:org67801d2}]{Physical Mediator: Heating Difference}
\begin{columns}
...
\begin{frame}[label={sec:org8f5cccb}]{Conclusion and Discussion}
\begin{itemize}
...
\begin{frame}[label={sec:org4e06df6}]{Applications, Next Steps, Limitations}
\begin{itemize}
...
\begin{frame}[label={sec:orgda59867}]{Acknowledgements}
\begin{itemize}
...
\begin{frame}[label={sec:orgcc97b05}]{References}
