...
write.table(ff, file = "./data/CESM1/ff.csv", sep = ",")
...
write.table(bmb, file = "./data/CESM1/bmb.csv", sep = ",")
...
write.table(luc, file = "./data/CESM1/luc.csv", sep = ",")
...
write.table(mydate, file = "./data/mydate.csv", sep = ",")
